...
export interface ApiCarpetCarpet extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slideshow: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
...
export interface ApiHardwoodHardwood extends Struct.CollectionTypeSchema {
  collectionName: 'hardwoods';
  info: {
    displayName: 'Hardwood';
    pluralName: 'hardwoods';
    singularName: 'hardwood';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiVinylVinyl extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::vinyl.vinyl'> &
      Schema.Attribute.Private;
    photo1: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    publishedAt: Schema.Attribute.DateTime;
    slideshow: Schema.Attribute.Media<
